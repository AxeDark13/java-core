...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String expessionText = "122 - 34 - 4 * (55 + 5 * (3 - 2)) * 2";
        expessionText = "-(5 + 2) + -5 * 3";
        expessionText = "-(5 + 2) + pow(2, min(7, 4 + 2, 5, 7))";
        List<Lexeme> lexems = lexAnalyze(expessionText);
        LexemeBuffer lexemeBuffer = new LexemeBuffer(lexems);
    ...
    public static class LexemeBuffer {
        ...
        public LexemeBuffer(List<Lexeme> lexemes) {this.lexems = lexemes;}

        public Lexeme next() {return lexems.get(pos++);}
